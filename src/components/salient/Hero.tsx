    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">Central Asian Markets</span>
        </span>
      </h1>
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        <Button color="blue" href="/register">Start Selling</Button>
        <Button
          href="/buyer"
          outline
        >
          ...
          <span className="ml-3">Find Suppliers</span>
        </Button>
      </div>
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          Trusted by leading companies across Central Asia
        </p>
        <ul
          role="list"
        ...
        >
          {[
            ...
            <li key={groupIndex}>
              ...
              >
                {group.map((country) => (
                  <li key={country.name} className="flex items-center gap-x-3">
